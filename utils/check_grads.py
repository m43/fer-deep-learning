...
def rel_error(x, y):
    ...
    # TODO understand hwy exactly this formula is used
    #      I think that Andrew Ng suggested (and thus used it in lab0):
    #      np.linalg.norm(x - y) / np.linalg.norm(x) + np.linalg.norm(y)
